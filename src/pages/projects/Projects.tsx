          ...
          {projects.map((project) => (
            <div key={project.title} className="rounded-[16px] border bg-[#FFFFFF]">
              ...
              <div className="relative">
                <img src={project.image} alt={project.title} className="w-full h-[200px] object-cover rounded-t-[16px] relative" />
              ...
              {/* Card Body */}
              <div className="p-8">
                <h3 className="font-heading font-bold text-[24px] leading-[1.3] tracking-[0.6px] mb-[10.8px]">{project.title}</h3>
                <p className="text-[#4D556B] leading-[1.6] font-normal">{project.description}</p>

                {/* Tags */}
                <div className="flex gap-2 mt-[14px]">
                  {project.tags.map((tag) => (
                    <span key={tag} className="rounded-full border border-[#D1D5DB] text-[#006A71] font-liberation text-[10px] font-bold leading-[1.5] px-[12px] py-[4px]">{tag}</span>
                  ))}
                </div>

                {/* Card Footer */}
                <div className="flex flex-col gap-3 mt-[21.2px]">

                  {/* Live Demo */}
                  <a href={project.liveDemo} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-[8px] text-[#FFFFFF] font-heading font-bold text-[14px] leading-[1.4] py-[12px] px-[24px] bg-gradient-to-r from-[#00DEEC] to-[#C180FF] rounded-[20px]">
                    <span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {/* Frontend GitHub */}
                    <a href={project.frontend} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-[8px] font-heading font-bold text-[14px] leading-[1.4] py-[12px] px-[16px] border border-[#D1D5DB] rounded-[20px] text-[#141F38] hover:border-[#006A71] hover:text-[#006A71] duration-300">
                    ...
                    {/* Backend GitHub */}
                    <a href={project.backend} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-[8px] font-heading font-bold text-[14px] leading-[1.4] py-[12px] px-[16px] border border-[#D1D5DB] rounded-[20px] text-[#141F38] hover:border-[#006A71] hover:text-[#006A71] duration-300">
