            ...
            <div key={project.title} className="rounded-[16px] border bg-[#FFFFFF]">
              ...
              <div className="relative">
                ...
                <div className="absolute top-3 left-3 flex gap-2 z-20">
                  {project.tags.map((tag) => (
                    <span key={tag} className="shadow-xl rounded-full bg-[#FFFFFF]/90 text-[#006A71] font-liberation text-[10px] font-bold leading-[1.5] px-[12px] py-[4px]">{tag}</span>
                  ))}
                </div>
              </div>
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between">
                  <button className="flex items-center gap-[8px] text-[#FFFFFF] font-heading font-bold text-[14px] leading-[1.4] py-[12px] px-[75.5px] bg-gradient-to-r from-[#00DEEC] to-[#C180FF] rounded-[20px] mt-[21.2px] ">
                  ...
                  <button><svg width="20" height="12" viewBox="0 0 20 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 12L0 6L6 0L7.425 1.425L2.825 6.025L7.4 10.6L6 12V12M14 12L12.575 10.575L17.175 5.975L12.6 1.4L14 0L20 6L14 12V12" fill="#141F38"/>
              </svg>
              </button>
                </div>
              </div>
