...
export const Contact = () => {
  ...
  return (
    <section className="bg-[#F4FAFF] relative"> 
    <div className="absolute top-0 left-0 bg-[#00696D]/20 blur-[160px] w-[608px] h-[608px] opacity-50 mix-blend-multiply rounded-full" ></div>
    <div className="absolute bottom-0 right-0 bg-[#6750A4]/20 blur-[160px] w-[608px] h-[608px] opacity-50 mix-blend-multiply rounded-full" ></div>
    <div ref={sectionRef} className="container mx-auto w-full py-20 px-6">
      <div>
        {/* Header */}
        ...
        {/* Content Grid */}
        <div ref={contentRef} className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <p className="text-[13px] font-semibold text-[#4D556B] uppercase tracking-[0.5px]">Email Me</p>
                <p className="text-[16px] font-semibold text-[#141F38] mt-1">hello@alchemist.dev</p>
              </div>
            </div>

            {/* Phone Section */}
            <div className="flex gap-4 items-start">
              <div className="w-12 h-12 rounded-full bg-[#F3E5F5] flex items-center justify-center flex-shrink-0">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                <p className="text-[13px] font-semibold text-[#4D556B] uppercase tracking-[0.5px]">Call Me</p>
                <p className="text-[16px] font-semibold text-[#141F38] mt-1">+1 (555) 0'10-CODE</p>
              </div>
            </div>

            {/* Digital Footprint */}
            <div className="pt-4">
              <p className="text-[13px] font-bold text-[#141F38] uppercase tracking-[0.5px] mb-4">Digital Footprint</p>
            ...
            {/* Image */}
            <div className="pt-8">
              <div className="relative w-full h-[320px] rounded-[20px] overflow-hidden bg-gradient-to-br from-[#006A71] to-[#004D54]">
          ...
          {/* Right Column - Form */}
          <form onSubmit={handleSubmit} className="bg-white rounded-[24px] shadow-lg p-8 md:p-10 relative">
            <div className="absolute right-0 top-0 w-[128px] h-[128px] bg-[#00696D]/20 rounded-full blur-[64px]"></div>
            <div className="space-y-6">
              {/* Full Name */}
              <div>
                <label className="block text-[13px] font-semibold text-[#141F38] uppercase tracking-[0.5px] mb-3">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <button
                type="submit"
                className="w-full py-3 px-6 bg-gradient-to-r from-[#006A71] to-[#8E33E4] text-white font-bold rounded-[20px] hover:shadow-lg transition-shadow duration-300 flex items-center justify-center gap-2"
              >
                <span>Transmute Vision into Reality</span>
              ...
              {/* Response Time */}
              <p className="text-center text-[13px] text-[#5A6275]">
